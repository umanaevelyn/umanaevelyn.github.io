...
Científica de la salud especializada en inflamación alérgica, eje intestino-pulmón y menopausia → en transición a **Data Science y Machine Learning aplicado a investigación clínica y biomedicina**.

### Skills  
Python • Pandas • NumPy • Scikit-learn • XGBoost • Matplotlib • Seaborn • SQL • Git • Estadística avanzada • Biomarcadores • Diseño experimental

### Proyectos destacados
- **Menopause & Allergic Inflammation Biomarkers**  
  Modelos predictivos de exacerbaciones asmáticas post-menopausia  
  [Repositorio](https://github.com/umanaevelyn/menopause-data-analysis) | En desarrollo
