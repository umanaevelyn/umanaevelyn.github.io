...
Health scientist with 8+ years of translational research in allergic inflammation, gut–lung axis, menopause immunology, obesity-induced asthma, and microbiota–immune interactions (preclinical models BALB/c, C57BL/6).  
Now turning biomedical complexity into real-world health solutions with Data Science & Machine Learning.

### Skills
Python • Pandas • NumPy • Scikit-learn • XGBoost • Matplotlib • Seaborn • SQL • Git • Advanced Statistics • Biomarkers • Experimental Design
